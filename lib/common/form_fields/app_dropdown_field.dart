  ...
  Widget build(BuildContext context) {
    return FormField<String>(
      ...
      builder: (formState) {
        ...
        final borderColor = hasError ? AppColors.red : AppColors.primaryLight;

        final headerText = hasError ? formState.errorText : null;
        final headerTextColor = hasError ? AppColors.red : AppColors.text;
        final textColor = hasError ? AppColors.red : AppColors.text;
        ...
        final decoration = CustomDropdownDecoration(
          ...
          expandedBorder: Border.all(color: AppColors.green, width: 1),
          ...
          searchFieldDecoration: SearchFieldDecoration(
            ...
            hintStyle: AppTextStyles.s14w400.copyWith(color: AppColors.grey.withOpacity(0.5)),
          ),
        );

        final disabledDecoration = CustomDropdownDisabledDecoration(
          hintStyle: AppTextStyles.s14w400.copyWith(color: AppColors.grey.withOpacity(0.5)),
          headerStyle: AppTextStyles.s14w400.copyWith(color: AppColors.grey.withOpacity(0.5)),
